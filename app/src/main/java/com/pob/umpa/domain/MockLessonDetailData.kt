...
object MockLessonDetailData {
    val mockLessonDetailData = LessonDetailModel(
        lessonSummary = MatchingModel(
            lessonId = "lesson001",
            teacherId = "teacher001",
            teacherName = "김현지",
            title = "피아노 반주 레슨",
            content = "경험 많은 선생님과 함께 피아노 반주를 배워보세요.dddddddddddddddddddddddddddddddddddddddddddd",
            price = 30000,
            stars = 5.0f,
            matchingType = "레슨",
            instrumentsType = "피아노",
            ...
            schedule = "협의 가능",
            location = "서울 연남동",
            lessonStyle = listOf(LessonStyle.OFFLINE, LessonStyle.ONLINE, LessonStyle.TRIAL),
